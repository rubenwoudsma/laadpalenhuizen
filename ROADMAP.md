...
### 3. Pricing quality report

**Doel:** na iedere datarun direct zien of de prijsdekking beter of slechter wordt.

**Voorgestelde output:** `pricing-quality.json` en een korte GitHub Actions summary met minimaal:
- totaal aantal locaties;
- locaties met regulier NDW-tarief;
- regionale of mediane fallbacks;
- locaties zonder CPO-basistarief;
- locaties waar direct betalen bekend is;
- Direct / QR geprijsd via NDW;
- Direct / QR geprijsd via officiele CPO-bron;
- direct betalen bekend maar nog ongeprijsd;
- aantallen `high`, `medium` en `low` confidence;
- bronnen die tijdens de run niet konden worden geverifieerd.

**Acceptatiecriteria:** een regressie in tariefdekking is zichtbaar zonder `huizen-data.json` handmatig te inspecteren.
